...
public final class ConnectionManager {
     ...
     * @return the {@link me.mast3rplan.phantombot.jerklib.Session} for this connection
     */
        ...
        for (IRCEvent event : events) {
            ...
            for (IRCEventListener listener : templisteners) {
                try {
                    ...
                    System.err.println("me.mast3rplan.phantombot.jerklib:Cought Client Exception");
                    e.printStackTrace();
                }
            }
    ...
    void connect(Session session) throws IOException {
        ...
        System.out.println ("Connecting to " + session.getRequestedConnection().getHostName() + ":" + session.getRequestedConnection().getPort());
