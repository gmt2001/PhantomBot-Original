...
var announceSchedule = function() {
    ...
    datefmt.setTimeZone(java.util.TimeZone.getTimeZone("PST"));
    ...
    $.say("Current Time: " + timestamp + " " + $.timezone);
        ...
        if (args.length == 0) {
            ...
            if (args[0].equalsIgnoreCase("clear")) {
                ...
                if (data.indexOf(" ") == -1 || $.strlen(data) < data.indexOf(" ") + 1) {
                    $.say("Usage: '!marathon schedule add <name1> <date1 MM/DD> <time1 HH:MM PST> [<name2> <date2> <time2>...]', '!marathon schedule delete <date MM/DD> <time HH:MM>'");
                    return;
                } else {
